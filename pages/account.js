...
<div class="user-view">
  <nav class="user-view__menu">
    <ul class="side-nav">
      <li class="side-nav--active"><a href="#">
          <svg>
    ...
    <div class="user-view__form-container">
      ...
      <form class="form form-user-data">
        <div class="form__group">
          ...
          <input class="form__input" id="name" type="text" value="Ismail" required="required"/>
        </div>
        <div class="form__group ma-bt-md">
          <label class="form__label" for="email">Email address</label>
          <input class="form__input" id="email" type="email" value="ismailinayat@gmail.com" required="required"/>
        </div>
        <div class="form__group form__photo-upload"><img class="form__user-photo" src="/img/users/" alt=""/>
